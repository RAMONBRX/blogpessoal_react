...
function Cadastro() {
  ...
  // useEffect que vai controlar o reirecionamento para de login caso o cadastro seja bem sucedido
  useEffect( () => {
    if(usuario.id !== 0){
      retornar()
    }
  ...
  // Função de atualização do estado confimar senha
  function handleConfirmarSenha(e: ChangeEvent<HTMLInputElement>){
    setConfirmarSenha(e.target.value)
  }

  // Função para enviar os dados parra o Backend (Submit)
  async function cadastrarNovoUsuario(e: SyntheticEvent<HTMLFormElement>) {
    ...
    if(confirmarSenha === usuario.senha && usuario.senha.length >= 8){
      ...
      try{
        ...
        ToastAlerta("Erro ao cadastrar o usuáro!", "erro")
      }
    }else{
